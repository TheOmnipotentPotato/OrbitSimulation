...
class Planet:
    ...
    @classmethod
    def decreas_timestep(cls, mult=3):
        cls.TIMESTEP -= 3600 * mult

    @classmethod
    def increase_timestep(cls, mult=3):
        cls.TIMESTEP += 3600 * mult
...
def main():
    ...
    mars = Planet(-1.524 * Planet.AU, 0, 13, RED, 6.39 * 10**23)
    mars.y_vel = 24.077 * 1000

    mercury = Planet(0.387 * Planet.AU, 0, 8, DARK_GREY, 33.0 * 10**22)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_LEFT:
                    Planet.decreas_timestep()
                    print(Planet.TIMESTEP)

                if event.key == pygame.K_RIGHT:
                    Planet.increase_timestep()
                    print(Planet.TIMESTEP)
